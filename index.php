    ...
    <table id="example" class="display" style="width:100%">
      ...
      <tbody>
        ...
        foreach ($results as $result) {
          echo "<tr><td><a href='editPersonGoogle.php?id=" . $result["person_id"] . "'>" . $result["name"] . "</a></td><td>" . $result["surname"] . "</td><td>" . $result["year"] . "</td><td>" . $result["city"] . "</td><td>" . $result["type"] . "</td><td>" . $result["discipline"] . "</td></tr>";
